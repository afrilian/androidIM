...
{
	private static final String AUTHENTICATION_SERVER_ADDRESS = "http://10.0.3.2/android-im/"; //url webAPI localhost yang ada di server local
	// IP address '192.168.0.54' adalah backup project ini ,,, '10.0.3.2' untuk localhost genymotion ,,, '127.0.0.1' untuk localhost xmpp
